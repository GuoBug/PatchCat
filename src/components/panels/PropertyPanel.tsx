                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    onClick={() => {
                      ...
                      updateNodeConfig(id, { tools: [...tools, newTool] });
                    }}
                    className="flex items-center gap-1 text-[10px] text-violet-600 hover:text-violet-700 bg-violet-50 hover:bg-violet-100 px-2 py-1 rounded transition-colors"
                  >
                    <Plus className="w-3 h-3" />
              ...
              <div className="space-y-3">
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <label className="text-xs text-slate-600 dark:text-slate-300">{t.propertyPanel.agentMaxIterations}</label>
                  ...
                  <input
                    ...
                    step="1"
                    value={maxIterations}
                    onChange={(e) => updateNodeConfig(id, { maxIterations: parseInt(e.target.value, 10) })}
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <label className="text-xs text-slate-600 dark:text-slate-300">{t.propertyPanel.temperature}</label>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800/80">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => updateNodeConfig(id, { inputArrayVariable: e.target.value })}
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={(e) => updateNodeConfig(id, { maxConcurrency: parseInt(e.target.value, 10) || 1 })}
                    className="w-full px-2.5 py-1.5 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-mono"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  <input
                    type="number"
                    value={itemTimeoutMs}
                    onChange={(e) => updateNodeConfig(id, { itemTimeoutMs: parseInt(e.target.value, 10) || 30000 })}
                    className="w-full px-2.5 py-1.5 rounded bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-xs font-mono"
                  />
                </div>
              </div>
            ...
            <div className="space-y-3 pt-4 border-t border-slate-200 dark:border-slate-800/80">
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={(e) => updateNodeConfig(id, { targetWorkflowId: e.target.value })}
