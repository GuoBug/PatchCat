...
const methodBadges: Record<HttpMethod, string> = {
  ...
  PATCH: 'bg-violet-100 text-violet-800 dark:bg-purple-500/20 dark:text-purple-300 border-violet-300 dark:border-purple-500/30',
  DELETE: 'bg-rose-100 text-rose-800 dark:bg-rose-500/20 dark:text-rose-300 border-rose-300 dark:border-rose-500/30',
};
