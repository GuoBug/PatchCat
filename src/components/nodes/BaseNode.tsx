...
> = {
  ...
  prompt: {
    icon: FileText,
    color:
      'bg-violet-50 text-violet-700 border-violet-200 dark:bg-purple-500/10 dark:text-purple-400 dark:border-purple-500/30',
    handleColor: '#8B5CF6',
    badge: 'PROMPT',
  },
  llm: {
    icon: Bot,
    color:
      'bg-blue-50 text-blue-700 border-blue-200 dark:bg-sky-500/10 dark:text-sky-400 dark:border-sky-500/30',
    handleColor: '#3B82F6',
    badge: 'LLM',
  },
  code: {
  ...
  output: {
    icon: CheckCircle2,
    color:
      'bg-rose-50 text-rose-700 border-rose-200 dark:bg-pink-500/10 dark:text-pink-400 dark:border-pink-500/30',
    handleColor: '#F43F5E',
    badge: 'OUTPUT',
  },
  knowledge: {
...
const statusStyles: Record<NodeStatus, { border: string; badge: string; icon: ReactNode }> = {
  ...
  queued: {
    border:
      'border-amber-400 dark:border-amber-500/50 border-dashed bg-amber-50/20 dark:bg-slate-900/90',
    badge:
  ...
  running: {
    ...
    badge:
      'bg-blue-50 text-blue-700 border border-blue-200 dark:bg-sky-500/20 dark:text-sky-300 dark:border-sky-500/40 animate-pulse',
  ...
  error: {
    border:
      'border-rose-500 bg-rose-50/20 dark:bg-slate-900/95 shadow-md shadow-rose-500/20 ring-1 ring-rose-500',
    badge:
  ...
  skipped: {
    border:
      'border-slate-300 dark:border-slate-800/80 border-dashed opacity-50 bg-slate-50/50 dark:bg-slate-950/40',
    badge:
        ...
        {executionResult && (
          <div className="px-3 py-1.5 border-t border-slate-100 dark:border-slate-800/60 bg-slate-50 dark:bg-slate-950/60 rounded-b-xl flex items-center justify-between text-[10px] font-mono text-slate-500 dark:text-slate-400">
            ...
            {executionResult.error && (
              <span
                className="text-rose-600 dark:text-rose-400 truncate max-w-[150px]"
